      ...
      >
        ...
        <Flex cssx={{ mr: "-1rem" }}>
          <Element as="a" href="#" target="_blank" rel="noopener noreferrer">
            <Element as="img" src="/career/icon_facebook.svg" alt="icon_facebook" cssx={trustStyle.icon} />
          </Element>
          <Element as="a" href="#" target="_blank" rel="noopener noreferrer">
            <Element as="img" src="/career/icon_twitter.svg" alt="twitter" cssx={trustStyle.icon} />
          </Element>
          <Element as="a" href="#" target="_blank" rel="noopener noreferrer">
            <Element as="img" src="/career/icon_linkedin.svg" alt="linkedin" cssx={trustStyle.icon} />
          </Element>
          <Element as="a" href="#" target="_blank" rel="noopener noreferrer">
            <Element as="img" src="/career/icon_subtract.svg" alt="subtract" cssx={trustStyle.icon} />
          </Element>
        </Flex>
      </Flex>
    </>
